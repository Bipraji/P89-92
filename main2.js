...
function givenum(){
    ...
    document.getElementById('ans').innerHTML = "<h2>"+ num1 +" X " + num2 +"</h2>" + "<br><br>  <input type='number' id='as' class='form-control' placeholder='Answer here'><br><button onclick='submit_ans()' class='btn btn-success'>Check</button>"; 
